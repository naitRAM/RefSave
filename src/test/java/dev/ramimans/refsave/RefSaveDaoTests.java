...
public class RefSaveDaoTests {
    ...
    @Test
    public void testAddGetAllReferences() throws MalformedURLException {
        ...
        assertTrue("allReferences does not contain tv", allReferences.contains(film));
        assertTrue("allReferences does not contain tv", allReferences.contains(website));
    }
